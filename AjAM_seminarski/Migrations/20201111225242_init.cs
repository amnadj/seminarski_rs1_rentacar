    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Feature_Car_Details", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Features_Details", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "Amount", "CategoryID", "Description", "Name", "Price" },
                values: new object[,]
                {
                    { 1, 5, 1, "Super brzo auto", "Auto 1", 120f },
                    { 2, 15, 1, "Super brzo auto", "Auto 2", 120f },
                    { 3, 3, 1, "Super brzo auto", "Auto 3", 160f },
                    { 4, 2, 1, "Super brzo auto", "Auto 4", 110f },
                    { 5, 7, 1, "Super brzo auto", "Auto 5", 70f }
                });
